...
@interface SmartMarkableViewController()
...
@implementation SmartMarkableViewController
{
    //private members
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([(GreetZAPFestivals*)theName isChecked])
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if ([(GreetZAPFestivals*)objectItem isChecked]) {
        
		cell.accessoryType = UITableViewCellAccessoryNone;
		[(GreetZAPFestivals*)objectItem setIsChecked:NO];
	}
	else {
        if (/*maximum allowed items*/0) {
            
            //TODO: Need to show the alert to user
        }
        else {
            
             cell.accessoryType = UITableViewCellAccessoryCheckmark;
            [(GreetZAPFestivals*)objectItem setIsChecked:YES];
        }
	}
